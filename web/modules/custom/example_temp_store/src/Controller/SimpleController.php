...
namespace Drupal\example_temp_store\Controller;

use Drupal\Core\Controller\ControllerBase;
// DI.
use Drupal\Core\Messenger\MessengerInterface;
use Drupal\example_temp_store\MyServices;
...
class SimpleController extends ControllerBase {
     ...
     * Custom service.
     *
     * @var \Drupal\example_temp_store\MyServices
     */
    private $myServices;
    /**
     * Inject services.
    ...
    public static function create(ContainerInterface $container)
    {
        return new static(
            ...
            $container->get('example_temp_store.myservices')
        );
    }
    /**
    ...
    public function showRssItems()
    {
        ...
        $tempstore = $this->tempStoreFactory->get('example_temp_store');
    ...
    try {
      ...
      $this->loggerFactory->get('example_temp_store')->alert(t('@err',['@err' => $error]));
    }
    */
        // 3. Display a simple message with the data retrieved from the tempstore
        ...
        $build[]['back'] = [
            ...
            '#url' => URL::fromRoute('example_temp_store.store_form'),
        ];
