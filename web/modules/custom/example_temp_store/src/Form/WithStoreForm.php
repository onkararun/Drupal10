...
namespace Drupal\example_temp_store\Form;
...
class WithStoreForm extends FormBase {
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        // 2. Create a PrivateTempStore object with the collection 'example_temp_store'.
        ...
        try {
            ...
            $form_state->setRedirect('example_temp_store.simple_controller_show_item');
